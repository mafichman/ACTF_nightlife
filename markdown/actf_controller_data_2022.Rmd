...
This section analyzes Philadelphia Police Department (PPD) firearm incident reports from January, 2017 to June, 2022 in relation to the location of restaurants, special assembly occupancy licenses and entertainment licenses. We do not have specific information about when specific establishments open or close.
...
```{load_crime_data, echo=FALSE, message=FALSE, warning=FALSE}
...
The following plots show all firearm incidents since 2020, broken down by day of the week and hour reported. The 12PM (0h) time of day has the highest reporting count by far of any time of day.
...
We related these firearm incidents to two types of data, wanting to know how frequently incidents were happening near hospitality locations at night.
...
We examined firearm incidents in commercial corridors and within 200 feet of restaurants, assembly and amusement businesses. Incident count is lower than outside these areas (residential, industrial, etc). 
