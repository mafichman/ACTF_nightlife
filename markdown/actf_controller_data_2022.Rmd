...
Starting in late 2021, amusement tax revenues began to near pre-pandemic levels and seasonal patterns, but have only surpassed pre-2020 trends in one single month since the pandemic began. Monthly tax revenues are still off between 10-60% with some strong fluctuations from month to month.
