...
Starting in late 2021, amusement tax revenues began to near pre-pandemic levels and seasonal patterns, but have only surpassed pre-2020 trends in one single month since the pandemic began. Monthly tax revenues are still off between 10-50% with some strong fluctuations from month to month.
...
amusement %>%
  ...
  ggplot()+
    ...
    labs(
        ...
        subtitle = "Adjusted for inflation to 2021 Dollars.\n Trend based on 2014-2019 regression controlling for year, month, sector. \nSource: Philadelphia City Controller's Office")+
    plotTheme
...
There are currently 122 SAOLs active in Philly, and 88 of those license holders also have amusement licenses.
